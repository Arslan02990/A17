...
// Auth information
global.pairNumber = "923035171619";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["923035171619", "919362639362"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["923035171619", "919362639362"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["923035171619"];
global.OwnerName = process.env.OWNER_NAME || "Arslan";
global.BotName = process.env.BOT_NAME || "A17";
global.packname = process.env.PACK_NAME || "Arslan king Bot";
global.author = "By: Kai";
global.BotSourceCode = "https://github.com/Kai0071/A17";
global.SupportGroupLink = "https://chat.whatsapp.com/LEZZV8zZzCwFMdadVKJuYB";
